...
def construct_4_champions_matrix():
    ...
    # 科目2：学生0和2排名前2，学生1和3排名3-4，学生4和5排名5-6
    subject2 = [1, 3, 2, 4, 5, 6, 7, 8]
...
def construct_effective_matrix():
    """
    构造一个更有效的排名矩阵，让A-D成为潜在冠军
    :return: 3x8的排名矩阵
    """
    # 科目0：学生0-5排名1-6，学生6-7排名7-8
    subject0 = [1, 2, 3, 4, 5, 6, 7, 8]
    
    # 科目1：学生0和3排名前2，学生1和2排名3-4，学生4和5排名5-6
    subject1 = [1, 3, 4, 2, 5, 6, 7, 8]
    
    # 科目2：学生1和2排名前2，学生0和3排名3-4，学生4和5排名5-6
...
if __name__ == "__main__":
    ...
    # 构造矩阵
    matrix = construct_effective_matrix()
    ...
    for student in range(4):
        student_orders = [k for k, v in order_champions.items() if v == student]
        print(f"学生{student}成为冠军的科目顺序: {student_orders}")
    
    print("\n" + "="*50)
    print("结论：")
    print("1. 根据引理1和引理2，G和H不可能成为潜在冠军。")
