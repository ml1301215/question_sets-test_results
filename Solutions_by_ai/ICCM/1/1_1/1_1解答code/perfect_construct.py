...
def construct_perfect_matrix():
    ...
    # 科目1：A和B排名前2，C和D排名3-4，E和F排名5-6
    subject1 = [1, 2, 3, 4, 5, 6, 7, 8]
    
    # 科目2：C和D排名前2，A和B排名3-4，E和F排名5-6
    subject2 = [3, 4, 1, 2, 5, 6, 7, 8]
    
    return [subject0, subject1, subject2]

# 构造一个更精确的矩阵
def construct_precise_matrix():
    """
    构造一个精确的排名矩阵，让A-D在特定科目顺序中成为冠军
    :return: 3x8的排名矩阵
    """
    # 科目0：A-F排名1-6，G-H排名7-8
    subject0 = [1, 2, 3, 4, 5, 6, 7, 8]
...
def construct_successful_matrix():
    ...
    # 科目1：A和D排名前2，B和C排名3-4，E和F排名5-6
    subject1 = [1, 3, 4, 2, 5, 6, 7, 8]
    
    # 科目2：B和C排名前2，A和D排名3-4，E和F排名5-6
    subject2 = [3, 1, 2, 4, 5, 6, 7, 8]
...
if __name__ == "__main__":
    # 测试完美矩阵
    print("测试完美矩阵：")
    perfect_matrix = construct_perfect_matrix()
    count, champions, order_champions = count_potential_champions(perfect_matrix)
    ...
    # 测试精确矩阵
    print("\n\n测试精确矩阵：")
    precise_matrix = construct_precise_matrix()
    count, champions, order_champions = count_potential_champions(precise_matrix)
    print(f"潜在冠军数量: {count}")
    print(f"潜在冠军学生: {champions}")
    print(f"各科目顺序对应的冠军: {order_champions}")
    ...
    # 测试成功矩阵
    print("\n\n测试成功矩阵：")
    successful_matrix = construct_successful_matrix()
    count, champions, order_champions = count_potential_champions(successful_matrix)
    print(f"潜在冠军数量: {count}")
    print(f"潜在冠军学生: {champions}")
    print(f"各科目顺序对应的冠军: {order_champions}")